...
export const Dashboard = () => {
  const { 
    totFC, totFR, totDette, fondsAsso, totGains, actLoans, members, 
    editFA, editFAV, setEditFAV, setFondsAsso, setEditFA, pushH, openM, sanctions, membersX 
  } = useApp();
        ...
        <Card>
          ...
          {editFA ? (
            <div style={{ display:"flex", gap:7 }}>
              <input style={{ background:"rgba(255,255,255,0.05)", border:`1px solid ${C.border}`, borderRadius:8, padding:"9px 14px", color:C.text, fontSize:13, width:"100%", outline:"none", boxSizing:"border-box", flex:1 }} type="number" value={editFAV} onChange={e => setEditFAV(e.target.value)}/>
